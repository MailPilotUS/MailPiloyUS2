    ...
    <View style={styles.container}>
      ...
      <View style={styles.benefitsWrap}>
        ...
        <View style={styles.benefitRow}>
          ...
          <Text style={styles.benefitText}>Forward, don't file — turn any email into a trackable task</Text>
        </View>
        <View style={styles.benefitRow}>
          <Text style={styles.benefitIcon}>✅</Text>
          <Text style={styles.benefitText}>Stay on top of follow-ups in one simple list</Text>
        </View>
        <View style={styles.benefitRow}>
          <Text style={styles.benefitIcon}>👥</Text>
          <Text style={styles.benefitText}>Assign tasks to your contacts straight from Gmail</Text>
        </View>
        <View style={styles.benefitRow}>
          <Text style={styles.benefitIcon}>🔔</Text>
          <Text style={styles.benefitText}>Get reminders before things fall through the cracks</Text>
        </View>
        <Text style={styles.benefitsPricing}>
          Unlock it all with MailPilotUS Pro — starting at $2.99/mo
        </Text>
      </View>
      <View style={styles.formWrap}>
        <Text style={styles.label}>Email address</Text>
